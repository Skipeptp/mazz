...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f0] text-stone-800 font-sans selection:bg-rose-100 selection:text-rose-900">
      {/* Navigation */}
      <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-white/80 backdrop-blur-md px-5 py-3 rounded-full shadow-2xl border border-white/50 flex items-center gap-5">
        <NavButton 
